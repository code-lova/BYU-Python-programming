...
# A nested function is a function that is defined inside another function and is useful 
# when we wish to split a large function into smaller functions and the smaller functions 
# will be called by the containing function only. The program in example 3 produces the same 
# results as examples 1 and 2, but it uses a nested function. Notice in example 3 at 
# lines 14–19 that the cels_from_fahr function is nested inside the main function.
