#A compound list is a list that contains lists. 
# Sorting a compound list is more complex than sorting a simple list. 
# Consider this compound list that contains data about some countries.
