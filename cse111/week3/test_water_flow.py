"""
Verify that the water_column_height, pressure_gain_from_water_height,
and function 3, functions work correctly.
"""
from water_flow import water_column_height, pressure_gain_from_water_height, pressure_loss_from_pipe,\
    pressure_loss_from_fittings, reynolds_number, pressure_loss_from_pipe_reduction, converts_kPa_to_psi
from pytest import approx
import pytest

def test_water_column_height():
    """Verify that the water_column_heigh function works correctly.
    Parameters: none
    Return: nothing
    """
...
def test_converts_kPa_to_psi():
    """Verify that the converts_kPa_to_psi function works correctly.
    Parameters: none
    Return: nothing
    """
    assert converts_kPa_to_psi(15) == approx(2.175566066, abs=0.001)
    assert converts_kPa_to_psi(158.7) == approx(23.017488978, abs=0.001)
    assert converts_kPa_to_psi(21) == approx(3.0457924923, abs=0.001)
