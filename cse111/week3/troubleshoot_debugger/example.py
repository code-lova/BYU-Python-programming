...
def main():
    ...
    #I usually declear my varables this way below to avoid such bugs in my code.
    #efficiency = miles_per_gallon(start_miles=prev_odom, end_miles=curr_odom, amount_gallons=fuel_amount)
