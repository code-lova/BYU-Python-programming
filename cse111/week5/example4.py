...
def main():
    ...
    dentist_list = read_compound_list("dentists.csv")
...
def read_compound_list(filename):
    ...
    Args:
        filename (_type_): the name of the CSV file to read

    Returns:
        list: a list of lists that contain strings
    """
    ...
    with open(filename, mode="rt") as csv_file:
        ...
        for row_list in reader:
            ...
            if len(row_list) != 0:
                ...
                compounr_list.append(row_list)
                
    # Return the compound list.        
    return compounr_list
