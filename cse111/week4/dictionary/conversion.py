...
def main():
    ...
    # two lists named numbers_list(Keys) andnames_list (values).
    numbers_list = list(student_dict.keys())
    names_list = list(student_dict.values())

    # Print both lists.
    print("Number list(Keys):", numbers_list)
    print()
    print("Namelist(Values):", names_list)
