...
def print_death_age(people_dict):
    ...
    for key, value in people_dict.items():
        #getting the value for person name from the dictionary list
        person_name = value[NAME_INDEX]
        
        #Substraction the value of both birth_age from death_age 
        #To get their individual death age
        details = value[BIRTH_YEAR_INDEX]
        details2 = value[DEATH_YEAR_INDEX]
        get_value =  details2 - details
        #variable to hold the death age for each 
        #person in the dictionary list
        person_death_age = get_value
        
        print(f"{person_name} {person_death_age}")
